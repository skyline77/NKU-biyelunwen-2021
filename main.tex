...
{\heiti 下载方式：}
\begin{itemize}
  \item 你可以在 \href{https://github.com/skyline77/NKU-biyelunwen-2021}{\texttt{GitHub NKU-biyelunwen-2021}} 下载文件，在本地使用。
            若无法登录GitHub，也可以在\href{https://pan.baidu.com/s/1RnDI7RqW5qRcyaw8ZpYMTw}{百度网盘}下载，提取码：\texttt{p4qv}，但更新速度可能较慢。
  \item 在Overleaf上使用模板（敬请期待）。
\end{itemize}
...
\begin{itemize}
  ...
  \item LaTeX 会自动在英文与中文之间插入空格，但这并不总是有效，例如在使用 \texttt{\textbackslash href} 功能时。此时需要你手动输入空格。
\end{itemize}
